...
export default function Categories() {
  ...
  const renderCustomMobileCard = (category: Category) => <Card key={category.id} className="mobile-card border-l-blue-500 py-0 overflow-visible">
      <div className="flex justify-between items-center px-0 py-2 border-b border-gray-100">
      ...
      <div onClick={() => handleViewSubcategories(category)} className="flex justify-between items-center px-0 py-3 cursor-pointer">
