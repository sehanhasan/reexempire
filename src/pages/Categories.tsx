...
export default function Categories() {
  ...
  const renderCustomMobileCard = (category: Category) => <Card key={category.id} className="mobile-card border-l-blue-500 px-3 py-2 overflow-visible">
      <div className="flex justify-between items-center px-1 py-0 border-b border-gray-100">
      ...
      <div onClick={() => handleViewSubcategories(category)} className="flex justify-between items-center px-1 py-2 cursor-pointer">
