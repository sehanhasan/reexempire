...
export default function ViewInvoice() {
  ...
  return (
    <div className="min-h-screen bg-background" style={{ minWidth: '1024px' }}>
      <div className="p-3 invoice-content">
        <div className="max-w-4xl mx-auto space-y-3">
          ...
          <div className="bg-white rounded-lg shadow-sm p-3">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                {invoice.subject && (
                  <div className="mt-2 pt-1 border-t">
                    <p className="text-xs text-gray-800 font-semibold mb-1">Subject: {invoice.subject}</p>
                  </div>
                )}
              </div>
              ...
              <div>
                <div className="mb-2">
                  <h1 className="text-lg font-bold text-gray-900">Invoice #{invoice.reference_number}</h1>
                  <Badge className={`mb-1 text-xs ${getStatusColor(displayPaymentStatus)}`}>
                ...
                <table className="w-full text-xs">
                  <thead className="bg-gray-100">
                    <tr>
                      ...
                      <th className="text-right p-2 font-semibold text-gray-700 w-12">Price</th>
          ...
          {images.length > 0 && (
            <Card className="shadow-sm">
              <CardContent className="p-3">
                <h3 className="font-semibold text-gray-700 mb-2 text-sm">Work Photos</h3>
                  ...
                  {images.map((image, index) => (
                    <div key={image.id} className="relative">
                      <img 
                        ...
                        className="w-full h-20 object-cover rounded-md cursor-pointer hover:opacity-90 transition-opacity shadow-sm"
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-3">
              ...
              {invoice.terms && (
                <Card className="shadow-sm">
                  <CardContent className="p-3">
                    ...
                    <p className="text-xs whitespace-pre-wrap">{invoice.terms}</p>
                  </CardContent>
                </Card>
              )}
              ...
              <Card className="shadow-sm">
                <CardContent className="p-3">
                  <h3 className="font-semibold text-gray-700 mb-2 text-sm">Payment Details</h3>
