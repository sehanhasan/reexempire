...
export default function Quotations() {
  ...
  return (
    <div className="page-container">
      ...
      <div className="mt-1">
        <div className="p-4 flex flex-col sm:flex-row justify-between gap-4 bg-background border rounded-lg">
        ...
        {loading ? (
          <div className="py-8 text-center bg-slate-100 rounded-lg mt-4">
            <p className="text-muted-foreground">Loading quotations...</p>
          </div>
        ) : filteredQuotations.length === 0 ? (
          <div className="py-8 text-center rounded-lg mt-4 border">
