...
export default function EditQuotation() {
  ...
  const handleConvertToInvoice = async () => {
    if (!quotationData) {
      toast({
        title: "Missing Information",
        description: "Quotation data not found.",
        variant: "destructive"
      });
      return;
    }
    ...
    try {
      ...
      // Get quotation items and create invoice items
      ...
      toast({
        ...
        description: `Invoice ${invoiceNumber} has been created successfully from quotation ${quotationData.reference_number}.`
      });
