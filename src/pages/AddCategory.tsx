            ...
            <CardContent className="space-y-6">
              {subcategories.filter(sub => !sub.deleted).map((subcategory, index) => <div key={typeof subcategory.tempId === 'string' ? subcategory.tempId : subcategory.tempId.toString()} className="space-y-4 pb-4 border-b last:border-b-0">
                  <div className="flex justify-between items-center bg-gray-100 px-2 rounded-md">
                    <h3 className="font-medium text-muted-foreground">Subcategory {index + 1}</h3>
              ...
              <Button type="button" variant="outline" onClick={addSubcategory} className="w-auto text-sky-600 border-sky-600">
