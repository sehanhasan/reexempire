...
import { Eye, Edit, MoreHorizontal, CalendarClock, Download, Plus, Search, Check, Send, AlertTriangle } from "lucide-react";
            ...
            {isLoading ? <div className="py-8 text-center">
                ...
                <Table>
                  ...
                  return <TableRow key={invoice.id}>
                          ...
                          <TableCell>
                            <Badge className={displayPaymentStatus === "Paid" ? "bg-green-100 text-green-800 hover:bg-green-100" : displayPaymentStatus === "Partially Paid" ? "bg-amber-100 text-amber-800 hover:bg-amber-100" : displayPaymentStatus === "Overdue" ? "bg-red-100 text-red-600 hover:bg-red-100" : "bg-amber-100 text-amber-800 hover:bg-amber-100"}>
