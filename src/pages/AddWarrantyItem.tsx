          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <FormField control={form.control} name="invoice_id" render={({
                field
              }) => <FormItem>
                ...
                <FormField control={form.control} name="warranty_date" render={({
                field
              }) => <FormItem>
              ...
              <div className="flex gap-4 justify-end">
                ...
                <Button type="submit" disabled={createWarrantyMutation.isPending} className="min-w-32">
        ...
        <DialogContent className="max-w-2xl">
          ...
          <div className="space-y-4">
            ...
            <ScrollArea className="h-60">
              <div className="space-y-2">
                {filteredCustomers.map(customer => <div key={customer.id} className="flex items-center justify-between p-3 border rounded-lg cursor-pointer hover:bg-accent" onClick={() => handleSelectCustomer(customer)}>
                    <div>
