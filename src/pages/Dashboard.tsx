      ...
      <Card className="border shadow-sm">
        ...
        <CardContent className="pt-0">
          {loading ? <div className="py-8 text-center">
              ...
              {upcomingAppointments.map(appointment => <div key={appointment.id} onClick={() => showAppointmentDetails(appointment)} className="flex items-center justify-between p-3 bg-gradient-to-r from-blue-50 to-white rounded-lg border border-blue-200 hover:from-blue-100 hover:to-indigo-100 transition-all cursor-pointer">
        ...
        <Card className="border shadow-sm">
          ...
          <CardContent className="pt-0">
            {loading ? <div className="py-8 text-center">
              ...
              return <div key={quotation.id} onClick={() => navigateToQuotation(quotation.id)} className="flex items-center justify-between p-3 bg-gradient-to-r from-purple-50 to-white rounded-lg border border-purple-200 hover:from-purple-100 hover:to-pink-100 transition-all cursor-pointer ">
                      <div>
                        <h3 className="font-semibold text-slate-900 text-sm">
        ...
        <Card className="border shadow-sm">
          ...
          <CardContent className="pt-0">
            {loading ? <div className="py-8 text-center">
              ...
              return <div key={invoice.id} onClick={() => navigateToInvoice(invoice.id)} className="flex items-center justify-between p-3 bg-gradient-to-r from-emerald-50 to-white rounded-lg border border-emerald-200 hover:from-emerald-100 hover:to-teal-100 transition-all cursor-pointer">
                      <div>
                        <h3 className="font-semibold text-slate-900 text-sm">
      ...
      <Card className="border shadow-sm mt-4">
        ...
        <CardContent className="pt-0">
          {loading ? <div className="py-8 text-center">
              ...
              {lowStockItems.map(item => <div key={item.id} onClick={() => navigate(`/edit-inventory-item/${item.id}`)} className="flex items-center justify-between p-3 bg-gradient-to-r from-orange-50 to-white rounded-lg border border-orange-200 hover:from-orange-100 hover:to-red-100 transition-all cursor-pointer">
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      <h3 className="font-semibold text-slate-900 text-sm">
                        {item.name}
