  ...
  return <form onSubmit={handleSubmit} className="space-y-6">
      <Card>
        <CardContent className="pt-6 space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="residence">Location
          </Label>
          ...
          <div className="space-y-2">
            ...
            <div className="flex">
              ...
              <Input id="whatsapp" className="rounded-l-none" placeholder="e.g. 123456789" value={whatsapp} onChange={e => setWhatsapp(e.target.value)} required />
            </div>
